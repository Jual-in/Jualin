...
class BusinessContentProductAdapter(
    ...
    inner class ItemViewHolder(private val binding: ItemProductContentBinding) :
        ...
        fun bind(item: Product) {
            binding.apply {
                ...
                btnDeleteProduct.setOnClickListener { listener.onBusinessRemoveClick(item.id) }
            }
        }
    }
    ...
    inner class AddViewHolder(private val binding: ItemAddContentBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind() {
            binding.btnAddItem.setOnClickListener { listener.onBusinessAddClick() }
        }
    }
    ...
    interface OnBusinessClickListener {
        fun onBusinessRemoveClick(businessId: Int)
        fun onBusinessAddClick()
    }
}